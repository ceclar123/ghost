...
<link rel="stylesheet" type="text/css" href="<%=basePath%>css/animation.css" />
<!-- 返回顶部调用 begin -->
...
<body>
	<header>
		<nav id="nav">
			<ul>
				<li><a href="/">网站首页</a></li>
				<li><a href="/" target="_blank" title="个人博客模板">个人博客模板</a></li>
				<li><a href="<%=basePath%>album/showImage" target="_blank" title="图书推荐">相册</a></li>
				...
				<li><a href="/" target="_blank" title="JS实例代码演示">JS实例</a></li>
			</ul>
