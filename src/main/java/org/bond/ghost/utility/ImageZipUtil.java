...
public class ImageZipUtil {
	 ...
	 *            :压缩后的图片高
	 */
	public static void resize(InputStream in, String outImgPath, int new_w,
			int new_h) {
		resize(in, outImgPath, new_w, new_h, 1F);
	}
	 ...
	 *            :百分比
	 */
	public static void resize(InputStream in, String outImgPath, float ratio) {
		resize(in, outImgPath, ratio, 1F);
	}
	 ...
	 *            :图片质量
	 */
	public static void resize(InputStream in, String outImgPath, int maxLength) {
		resize(in, outImgPath, maxLength, 1F);
	}
	 ...
	 * @param per
	 */
	public static void resizeFixedWidth(InputStream in, String outImgPath,
			int width, float per) {
		// 得到图片
		BufferedImage src = InputImage(in);
		int old_w = src.getWidth();
